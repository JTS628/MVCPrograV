...
namespace PrograV.Miselanius
{
    public static class OwnerHelper
    {
        ...
        public static async void RemoveProperty(string ownerName, string email, string CondoName, int newHouseID, string uuid)
        {
            try
            {
                Dictionary<string, object> objectProperties = new Dictionary<string, object>
        ...
        public static async void RemoveOwnerIfnoproperties(string email)
        { 
            try
            {
